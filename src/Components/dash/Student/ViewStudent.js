...
export default function ViewStudent() {
  const classes = useStyles();
    return (
      ...
      <Input style={{width:'70px'}} color='primary' type='number'></Input>
      <Typography style={{marginLeft:'10px'}} variant="caption" display="block" gutterBottom>
      entries
      </Typography>
<Button style={{backgroundColor:'#1E7F95',marginLeft:'20px'}} variant="contained" color="primary">
  PDF
</Button>
<Button style={{backgroundColor:'#1E7F95',marginLeft:'20px'}}  variant="contained" color="primary">
  EXCELL
...
<TextField
        color='#FFC305'
        style={{marginLeft:'30px',width:'40%',marginRight:'10px',marginTop:'10px'}}
